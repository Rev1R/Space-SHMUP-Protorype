...
{
    /*Enemy_3 расширяет класс Enemy. Траектория движения Enemy_3 вычисляется путем линейной
    ...
    /*И снова метод Start() хорошо подходит для наших целей, потому что
      не используется суперклассом Enemy*/
